...
public class NPCWalkerAllies : MonoBehaviour
{
    public string allyTag = "Enemy"; // Tag for allied NPCs
    ...
    private void Update()
    {
        if (currentTarget != null)
        {
            ...
            {
                currentTarget = payloadTarget?.transform; // Default back to payload if no target found
            }
        ...
        {
            // If no target assigned, default to moving towards payloadTarget
            currentTarget = payloadTarget?.transform;
            MoveTowardsTarget();
        }
    ...
    private IEnumerator WaitForAttackAnimation()
    {
        ...
        // After attack and cooldown, resume moving towards payload or other target
        currentTarget = payloadTarget?.transform;
    }
